...
export function toJson_ChallengeSpecSolverHttp01GatewayHttpRoutePodTemplateSpecAffinity(
  ...
  const result = {
    ...
    podAffinity: toJson_ChallengeSpecSolverHttp01GatewayHttpRoutePodTemplateSpecAffinityPodAffinity(
      obj.podAffinity,
    ),
    podAntiAffinity:
...
export function toJson_ChallengeSpecSolverHttp01IngressPodTemplateSpecAffinity(
  ...
  const result = {
    ...
    podAntiAffinity: toJson_ChallengeSpecSolverHttp01IngressPodTemplateSpecAffinityPodAntiAffinity(
      obj.podAntiAffinity,
    ),
  };
  // filter undefined values
